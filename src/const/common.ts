...
export const NEXT_ENCODE_TIMES = clamp(1, 10, Number.parseInt(process.env.NEXT_ENCODE_TIMES || '3'))
export const NEXT_MAX_USER_COUNT = clamp(1, 10, Number.parseInt(process.env.NEXT_MAX_USER_COUNT || '10'))
